"""
Generates a visual graph dataset from the source CSV file of the lipophilicity dataset. This is a dataset 
that consists of ~4k molecule SMILES representations that are annotated with the experimentally determined
logD values for the octanol/water distribution coefficient.
"""
import os
import pathlib
import typing as t
...
CSV_FILE_NAME: str = 'source/lipophilicity.csv'
...
DATASET_META: t.Optional[dict] = {
    'version': '0.2.0',
    'changelog': [
        '0.1.0 - 28.11.2023 - initial version',
    ],
    'description': (
        'Dataset consisting of ~4k molecular graphs annotated with measured values of their '
        'corresponding logD octanol water coeffiecient.'
    ),
    'references': [
    ...
    'target_descriptions': {
        0: 'measured logD values of the molecules water to octanol coeffiecient'
    }
}
