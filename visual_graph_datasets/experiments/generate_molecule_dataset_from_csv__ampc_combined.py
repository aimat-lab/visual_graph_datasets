"""
This experiment processes the ampc combined dataset.
...
CSV_FILE_NAME: str = os.path.join(ASSETS_PATH, 'ampc_new_dataset_cleaned_smiles.csv')
...
DATASET_NAME: str = 'ampc_combined'
# :param IMAGE_WIDTH:
...
DATASET_META: t.Optional[dict] = {
    ...
    'description': (
        'large dataset consisting of organic compounds which are divided into two classes: class 0 '
        'and class 1.'
    ),
...
def add_filters(e: Experiment, filter_callbacks: t.List[t.Callable]):
    ...
    filter_callbacks.append(max_graph_size)
